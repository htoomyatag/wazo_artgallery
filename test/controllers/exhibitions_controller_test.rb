...
class ExhibitionsControllerTest < ActionController::TestCase
  ...
  test "should create exhibition" do
    assert_difference('Exhibition.count') do
      post :create, exhibition: { date: @exhibition.date, desc: @exhibition.desc, place: @exhibition.place, title: @exhibition.title }
    end
  ...
  test "should update exhibition" do
    patch :update, id: @exhibition, exhibition: { date: @exhibition.date, desc: @exhibition.desc, place: @exhibition.place, title: @exhibition.title }
    assert_redirected_to exhibition_path(assigns(:exhibition))
  end
